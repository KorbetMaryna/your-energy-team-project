  ...
  for (let i = 0; i < currentList.length; i += 1) {
    ...
    current.addEventListener('click', function (event) {
      ...
      if (clickedListItem) {
        ...
        const closeBtn =
          document.getElementsByClassName('main-modal__close')[0];
        ...
        function displayExerciseDetails(data) {
          const exerciseDetailsContainer =
            document.getElementById('exerciseDetails');
          ...
          <p class="main-modal__details-info">${
          ...
          exerciseDetailsContainer.innerHTML = `${
            gifImage +
            `<div class="main-modal__content-container">${`<div class="main-modal__content-wrapper">${
          ...
          function getTotalDetailsWidth() {
            const detailsWrappers = document.querySelectorAll(
              '.main-modal__details-wrapper'
            );
            let totalWidth = 0;
          ...
          function movePopularSectionIfNeeded() {
            const bottomDetailsContainer = document.querySelector(
              '.main-modal__bottom-details-container'
            );
            const popularSection = document.querySelector(
              '.main-modal__details-wrapper:nth-child(4)'
            );
            ...
            function applyRulesForScreenWidth(matches) {
              if (matches) {
                if (totalDetailsWidth > 364) {
                  bottomDetailsContainer.insertBefore(
                    popularSection,
                    bottomDetailsContainer.firstChild
                  );
                }
              } else {
