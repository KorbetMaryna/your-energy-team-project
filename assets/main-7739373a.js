import{a as $,i as L}from"./vendor-f9c1c104.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function i(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=i(a);fetch(a.href,o)}})();function h(e){const t=document.querySelector(".loader-container");e&&t.classList.remove("hidden"),t.classList.add("hidden")}document.addEventListener("DOMContentLoaded",function(){h(!0);const e=window.location.pathname.split("/").pop();document.querySelectorAll(".header-nav-list-item a").forEach(function(i){const s=i.getAttribute("href").split("/").pop();e===s||e===""&&s==="index.html"?(i.classList.add("header-nav-current"),h(!1)):(i.classList.remove("header-nav-current"),h(!1))})});(()=>{const e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),i=document.querySelector(".js-close-menu"),s=()=>{const a=t.getAttribute("aria-expanded")==="true"||!1;t.setAttribute("aria-expanded",!a),e.classList.toggle("is-open")};t.addEventListener("click",s),i.addEventListener("click",s),window.matchMedia("(min-width: 768px)").addEventListener("change",a=>{a.matches&&(e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1))})})();function T(){const e=document.getElementsByClassName("exercises-tiles-category-list"),t=document.getElementById("myModal"),i=document.getElementsByClassName("main-modal__close")[0];let s=localStorage.getItem("savedExercises")?JSON.parse(localStorage.getItem("savedExercises")):[];i&&(i.onclick=function(){t.style.display="none"}),window.onclick=function(r){r.target==t&&(t.style.display="none")};for(let r=0;r<e.length;r+=1)e[r].addEventListener("click",function(m){const u=m.target.closest(".exercises-category-tile-item");if(u){const p=u.dataset.id;t.style.display="flex";const y=`https://your-energy.b.goit.study/api/exercises/${p}`;$.get(y).then(c=>{if(c)return c.data}).then(c=>{a(c);const d=document.getElementById("fav-btn");if(d){const b=s.some(v=>v._id===c._id);d.querySelector(".main-modal__heart-icon use").setAttribute("href",b?"./img/icons.svg#icon-trash":"./img/icons.svg#icon-heart"),d.querySelector(".main-modal__btn-text").textContent=b?"Unfavorite":"Add to favorites",d.addEventListener("click",function(){const v=s.some(E=>E._id===c._id);v?s=s.filter(E=>E._id!==c._id):s.push(c),localStorage.setItem("savedExercises",JSON.stringify(s)),d.querySelector(".main-modal__btn-text").textContent=v?"Add to favorites":"Unfavorite",d.querySelector(".main-modal__heart-icon use").setAttribute("href",v?"./img/icons.svg#icon-heart":"./img/icons.svg#icon-trash")})}}).catch(c=>{console.error("There was a problem with the Axios request:",c)})}});function a(r){const g=document.getElementById("exerciseDetails");let m=null;r.gifUrl?m=`<div class="main-modal__gif-wrapper">
      ...
      </div>`;g.innerHTML=`${m+`<div class="main-modal__content-wrapper">${u+y+c+d+b}</div>`}`}function o(r){const g=`<div class="main-modal__star-wrapper"><svg class="main-modal__star-icon main-modal__colored-star">
      ...
      <use href="./img/icons.svg#icon-star"></use>
        ...
        </li>`).join("");n.tilesCategoryList.innerHTML=a,P(t,i,e)}function P(e,t,i){console.log("totalPages:",t),n.paginationList.innerHTML="";for(let s=1;s<=t;s++){const a=document.createElement("span");a.classList.add("exercises-pagination-item"),a.textContent=s,s==e&&a.classList.add("exercises-pagination-item-active"),a.addEventListener("click",()=>{l.page=s,w(i,l)}),n.paginationList.appendChild(a)}}function x(e){return e[0].toUpperCase()+e.slice(1)}const W=document.querySelector(".quote-wrapper");async function z(){const e=new Date().toLocaleDateString(),t=J(),i=JSON.parse(t);if(!i||i.date!=e){let{quote:s,author:a}=await G();I(s,a),Q(s,a,e)}else I(i.quote,i.author)}function Q(e,t,i){const s={quote:e,author:t,date:i};localStorage.setItem("quoteOfDay",JSON.stringify(s))}function J(){return localStorage.getItem("quoteOfDay")}async function G(){try{const{quote:e,author:t}=await O("quote","");return{quote:e,author:t}}catch(e){K(e.message)}}function I(e,t){const i=`<p class="quote quote-text">${e}</p>
    <p class="qoute-author">${t}</p>`;W.insertAdjacentHTML("beforeend",i)}function K(e){L.error({message:`${e}`})}z();
//# sourceMappingURL=main-7739373a.js.map
