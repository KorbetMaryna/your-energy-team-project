import{a as q,i as x}from"./vendor-f9c1c104.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=i(a);fetch(a.href,o)}})();document.addEventListener("DOMContentLoaded",function(){const e=window.location.pathname.split("/").pop();document.querySelectorAll(".header-nav-list-item a").forEach(function(i){const s=i.getAttribute("href").split("/").pop();e===s||e===""&&s==="index.html"?i.classList.add("header-nav-current"):i.classList.remove("header-nav-current")})});(()=>{const e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),i=document.querySelector(".js-close-menu"),s=()=>{const a=t.getAttribute("aria-expanded")==="true"||!1;t.setAttribute("aria-expanded",!a),e.classList.toggle("is-open")};t.addEventListener("click",s),i.addEventListener("click",s),window.matchMedia("(min-width: 768px)").addEventListener("change",a=>{a.matches&&(e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1))})})();function T(){const e=document.getElementsByClassName("exercises-tiles-category-list"),t=document.getElementById("myModal"),i=document.getElementsByClassName("main-modal__close")[0];let s=localStorage.getItem("savedExercises")?JSON.parse(localStorage.getItem("savedExercises")):[];i&&(i.onclick=function(){t.style.display="none"}),window.onclick=function(n){n.target==t&&(t.style.display="none")};for(let n=0;n<e.length;n+=1)e[n].addEventListener("click",function(m){const u=m.target.closest(".exercises-category-tile-item");if(u){const p=u.dataset.id;t.style.display="flex";const y=`https://your-energy.b.goit.study/api/exercises/${p}`;q.get(y).then(c=>{if(c)return c.data}).then(c=>{a(c);const d=document.getElementById("fav-btn");if(d){const _=s.some(v=>v._id===c._id);d.querySelector(".main-modal__heart-icon use").setAttribute("href",_?"./img/icons.svg#icon-trash":"./img/icons.svg#icon-heart"),d.querySelector(".main-modal__btn-text").textContent=_?"Unfavorite":"Add to favorites",d.addEventListener("click",function(){const v=s.some(w=>w._id===c._id);v?s=s.filter(w=>w._id!==c._id):s.push(c),localStorage.setItem("savedExercises",JSON.stringify(s)),d.querySelector(".main-modal__btn-text").textContent=v?"Add to favorites":"Unfavorite",d.querySelector(".main-modal__heart-icon use").setAttribute("href",v?"./img/icons.svg#icon-heart":"./img/icons.svg#icon-trash")})}}).catch(c=>{console.error("There was a problem with the Axios request:",c)})}});function a(n){const g=document.getElementById("exerciseDetails");let m=null;n.gifUrl?m=`<div class="main-modal__gif-wrapper">
      ...
      <use href="./img/icons.svg#icon-star"></use>
          ...
          <use href="./img/icons.svg#icon-star"></use>
          </svg></div>`}else u+=m;return`${u}`}}window.onload=function(){document.querySelector(".exercises-container")&&T()};const E=document.querySelector(".rating-backdrop"),M=document.querySelector(".rating__close-btn"),j=document.querySelector(".rating__submit-btn"),C=document.querySelectorAll(".rating__input"),$=document.querySelector(".rating__input-email"),k=document.querySelector(".rating__input-comment");let f=null;const h=()=>{E.classList.remove("modal-open"),M.removeEventListener("click",h)},A=e=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e),B=async()=>{const e=f==null?void 0:f.id,t=parseInt(e==null?void 0:e.replace("star",""),10);if(!t||isNaN(t)){console.log("Please add a rate");return}if(A($.value)){console.log("Please enter your email");return}if(k.value.length<=3){console.log("Please leave your review");return}const s="https://your-energy.b.goit.study/api/exercises/EXERCISE_ID/rating";try{(await q.patch(s,{rate:t,email:$.value,review:k.value})).status===200?iziToast.success({title:"Success",message:"Rating submitted successfully!"}):iziToast.error({title:"Error",message:"Failed to submit rating"})}catch{iziToast.error({title:"Error",message:"Failed to submit rating"})}h()},D=()=>{const e=Array.from(C);e.forEach((t,i)=>{const s=t.nextElementSibling.querySelector(".rating__icon-star");t===f||f&&i<e.indexOf(f)?(s.style.fill="var(--stars-color-activ)",s.style.opacity=1):(s.style.fill="var(--second-color-light-theme)",s.style.opacity=.2)})};C.forEach(e=>{e.addEventListener("click",function(t){f=t.target,D()})});E.addEventListener("click",function(e){e.target===E&&!e.target.closest(".rating__close-btn")&&!e.target.closest(".rating__submit-btn")&&h()});M.addEventListener("click",h);document.addEventListener("keydown",e=>{e.key==="Escape"&&h()});j.addEventListener("click",B);const F="https://your-energy.b.goit.study/api/";async function O(e,t){for(const a of Object.keys(t))t[a]===""&&delete t[a];const i=new URLSearchParams(t),{data:s}=await q(`${F}${e}?${i}`);return s}x.settings({position:"topRight",transitionIn:"bounceInDown",closeOnEscape:!0});const r={headlineWrapper:document.querySelector(".js-headline-category-wrapper"),headlineCategory:document.querySelector(".js-headline-category"),searchForm:document.querySelector(".js-search-form"),filterButtons:document.querySelectorAll(".js-button"),tilesFilterList:document.querySelector(".js-tiles-filter-list"),tilesCategoryList:document.querySelector(".js-tiles-category-list"),paginationList:document.querySelector(".js-pagination")};let l={filter:"Muscles",bodypart:"",muscles:"",equipment:"",keyword:"",page:1};function S(e,t){e!==""?l.limit=t<768?9:12:l.limit=t<768?8:10}S(l.filter,window.innerWidth);L("filters",l);r.filterButtons.forEach(e=>{e.addEventListener("click",()=>{Object.assign(l,{bodypart:"",muscles:"",equipment:""}),l.filter=e.innerText,l.page=1,L("filters",l),document.querySelector(".active-button").classList.remove("active-button"),e.classList.add("active-button")})});async function L(e,t){await O(e,t).then(i=>{var s;(s=i.results[0])!=null&&s.filter?(S(l.filter,window.innerWidth),N("filters",i),r.headlineCategory.innerText="",r.headlineWrapper.classList.add("visually-hidden"),r.searchForm.classList.add("visually-hidden")):(S(l.filter,window.innerWidth),R("exercises",i))}).catch(i=>{console.log(i),x.error({message:"Something went wrong :-( try again later."})})}function N(e,t){r.tilesCategoryList.innerHTML="",r.tilesCategoryList.classList.add("visually-hidden"),r.tilesFilterList.classList.remove("visually-hidden");const{page:i,totalPages:s,results:a}=t,o=a.map(({filter:n,name:g,imgURL:m})=>`      
        ...
        </li>`).join("");r.tilesCategoryList.innerHTML=a,P(t,i,e)}function P(e,t,i){console.log("totalPages:",t),r.paginationList.innerHTML="";for(let s=1;s<=t;s++){const a=document.createElement("span");a.classList.add("exercises-pagination-item"),a.textContent=s,s==e&&a.classList.add("exercises-pagination-item-active"),a.addEventListener("click",()=>{l.page=s,L(i,l)}),r.paginationList.appendChild(a)}}function b(e){return e[0].toUpperCase()+e.slice(1)}const H=document.querySelector(".quote-wrapper");async function W(){const e=new Date().toLocaleDateString(),t=Q(),i=JSON.parse(t);if(!i||i.date!=e){let{quote:s,author:a}=await J();I(s,a),z(s,a,e)}else I(i.quote,i.author)}function z(e,t,i){const s={quote:e,author:t,date:i};localStorage.setItem("quoteOfDay",JSON.stringify(s))}function Q(){return localStorage.getItem("quoteOfDay")}async function J(){try{const{quote:e,author:t}=await O("quote","");return{quote:e,author:t}}catch(e){G(e.message)}}function I(e,t){const i=`<p class="quote quote-text">${e}</p>
    <p class="qoute-author">${t}</p>`;H.insertAdjacentHTML("beforeend",i)}function G(e){x.error({message:`${e}`})}W();
//# sourceMappingURL=main-e67f756e.js.map
