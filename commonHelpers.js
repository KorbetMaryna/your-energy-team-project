import"./assets/showPageError-fed60901.js";import{i as v}from"./assets/vendor-09c79f2e.js";function f(t,e){return h(t===1).concat(w(t,e),m(t===e))}function w(t,e){let a="";for(let n=1;n<=e;n+=1){if(n<t-2){a=a.concat('<li><span class="pagination-number">...</span></li>'),n=t-3;continue}if(n>t+2){a=a.concat('<li><span class="pagination-number">...</span></li>');break}a=a.concat(`<li>
