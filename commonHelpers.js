import{s as d}from"./assets/showPageError-530a1e81.js";import"./assets/vendor-09c79f2e.js";function f(t,s){return h(t===1).concat(w(t,s),k(t===s))}function w(t,s){let a="";for(let n=1;n<=s;n+=1){if(n<t-2){a=a.concat('<li><span class="pagination-number">...</span></li>'),n=t-3;continue}if(n>t+2){a=a.concat('<li><span class="pagination-number">...</span></li>');break}a=a.concat(`<li>
